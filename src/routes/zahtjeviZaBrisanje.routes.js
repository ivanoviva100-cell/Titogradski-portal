...
router.get('/', autentifikujKorisnika, zahtijevajAdmina, async (req, res) => {
    try {
...
router.post('/:id/odluka', autentifikujKorisnika, zahtijevajAdmina, async (req, res) => {
...
//# sourceMappingURL=zahtjeviZaBrisanje.routes.js.map